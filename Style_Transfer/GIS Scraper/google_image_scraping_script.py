...
if __name__ == '__main__':
    ...
    qty = int(input("How many (200-300 optimal): "))

    queries = [query]  #change your set of queries here
    for query in queries:
        wd.get('https://google.com')
        search_box = wd.find_element_by_css_selector('input.gLFyf')
        search_box.send_keys(query)
        links = fetch_image_urls(query,qty,wd) # 200 denotes no. of images you want to download
